        ...
        foreach ($routes as $route) {
            ...
            if (is_array($method)) {
                ...
                foreach ($method as $value) {
                    if (strcasecmp($requestMethod, $value) == 0) {
                        $found = true;
                        break;
                    }
                }
            ...
            } elseif (strcasecmp($requestMethod, $method) != 0) {
                continue;
            }
            ...
            for ($i = 0; $i < $len; $i ++) {
                ...
                if ($is_regex) {
                    $route_to_match = $uri;
                    break;
                } elseif (! isset($requestUri[$i]) || $char != $requestUri[$i]) {
                    continue 2;
                }
                $route_to_match .= $char;
            }
            ...
            if (preg_match($regex, $requestUri, $params)) {
